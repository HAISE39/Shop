const CONFIG = {
nama: "VellStore", // Nama Store
profil: "https://pomf2.lain.la/f/tk9blto.jpg", // Url Profil
banner: "https://pomf2.lain.la/f/2c7i1ydx.jpg", // Url Banner 
tentang: "VellStore adalah toko online terpercaya yang telah melayani ribuan pelanggan sejak 2020. Kami menyediakan berbagai produk digital untuk kebutuhan sehari-hari dengan kualitas terbaik dan harga terjangkau.\n\nKomitmen kami adalah memberikan pengalaman berbelanja yang menyenangkan dengan pelayanan terbaik, produk original, dan garansi resmi untuk semua produk yang kami jual.",
alamat: "Lamongan, Indonesia",
sosial_media: {
  email: "aurcusojapan@gmail.com", // Email
  youtube: "Dimaswahyu414", // YouTube Username 
  tiktok: "VellStore", // Tiktok Username 
  whatsapp: "6285706400133", // WhatsApp Number 
  telegram: "VELLIX_AO" // Telegram Username
},
payment: {
  dana: "085706400133", // Payment Dana
  gopay: "085706400133", // Payment Gopay 
  ovo: "085706400133", // Payment Ovo 
  qris: "https://files.catbox.moe/r40rux.jpg" // Url Qris
},
telegram_api: {
  bot: "8002306553:AAHRAK5DkQMi4mfYM40jZPHFZz_rl5Q2Wk8", // Token bot father
  chatid: "8002306553" // ID telegram
},
}
            ...
            "Hosting": [
              {
                ...
                "variants": [
                  ...
                  { "name": "Unlimited RAM", "price": 15000 }
                ]
              },
              {
                "id": 2,
